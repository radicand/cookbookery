...
part 'unitSizeFragment.graphql.g.dart';
...
class Fragment$UnitSizeFragment {
  ...
  factory Fragment$UnitSizeFragment.fromJson(Map<String, dynamic> json) =>
      _$Fragment$UnitSizeFragmentFromJson(json);
  ...
  @JsonKey(unknownEnumValue: Enum$UnitType_enum.$unknown)
  final Enum$UnitType_enum unitType;

  @JsonKey(name: '__typename')
  final String $__typename;

  Map<String, dynamic> toJson() => _$Fragment$UnitSizeFragmentToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
...
abstract class CopyWith$Fragment$UnitSizeFragment<TRes> {
  factory CopyWith$Fragment$UnitSizeFragment(Fragment$UnitSizeFragment instance,
