...
class Query$recipes {
  Query$recipes({required this.Recipe, this.$__typename = 'query_root'});
  ...
  factory Query$recipes.fromJson(Map<String, dynamic> json) {
    ...
    return Query$recipes(
      Recipe: (l$Recipe as List<dynamic>)
          .map(
            (e) => Fragment$RecipePreviewFragment.fromJson(
...
const documentNodeQueryrecipes = DocumentNode(
  definitions: [
...
typedef OnQueryComplete$Query$recipes =
    FutureOr<void> Function(Map<String, dynamic>?, Query$recipes?);
...
extension ClientExtension$Query$recipes on graphql.GraphQLClient {
  ...
  ]) async => await this.query(options ?? Options$Query$recipes());
