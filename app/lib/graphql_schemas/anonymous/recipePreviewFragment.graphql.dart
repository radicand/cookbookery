...
class Fragment$RecipePreviewFragment {
  ...
  factory Fragment$RecipePreviewFragment.fromJson(Map<String, dynamic> json) =>
      _$Fragment$RecipePreviewFragmentFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$Fragment$RecipePreviewFragmentToJson(this);
  int get hashCode {
    final l$id = id;
    final l$title = title;
  ...
  TRes Files(
      ...
      call(
          Files: _fn(_instance.Files.map((e) =>
                  CopyWith$Fragment$RecipePreviewFragment$Files(e, (i) => i)))
              .toList());
  TRes RecipeTags(
          Iterable<Fragment$RecipePreviewFragment$RecipeTags> Function(
                  Iterable<
...
class Fragment$RecipePreviewFragment$Author {
  ...
  factory Fragment$RecipePreviewFragment$Author.fromJson(
      ...
      _$Fragment$RecipePreviewFragment$AuthorFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Fragment$RecipePreviewFragment$AuthorToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$$__typename = $__typename;
...
class Fragment$RecipePreviewFragment$Files {
  ...
  factory Fragment$RecipePreviewFragment$Files.fromJson(
          Map<String, dynamic> json) =>
      _$Fragment$RecipePreviewFragment$FilesFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Fragment$RecipePreviewFragment$FilesToJson(this);
  int get hashCode {
    final l$id = id;
    final l$$__typename = $__typename;
...
extension UtilityExtension$Fragment$RecipePreviewFragment$Files
  ...
  CopyWith$Fragment$RecipePreviewFragment$Files<
          Fragment$RecipePreviewFragment$Files>
      get copyWith =>
          CopyWith$Fragment$RecipePreviewFragment$Files(this, (i) => i);
}
...
class Fragment$RecipePreviewFragment$RecipeTags {
  ...
  factory Fragment$RecipePreviewFragment$RecipeTags.fromJson(
          Map<String, dynamic> json) =>
      _$Fragment$RecipePreviewFragment$RecipeTagsFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Fragment$RecipePreviewFragment$RecipeTagsToJson(this);
  int get hashCode {
    final l$Tag = Tag;
    final l$$__typename = $__typename;
...
class Fragment$RecipePreviewFragment$RecipeTags$Tag {
  ...
  factory Fragment$RecipePreviewFragment$RecipeTags$Tag.fromJson(
          Map<String, dynamic> json) =>
      _$Fragment$RecipePreviewFragment$RecipeTags$TagFromJson(json);
  ...
  Map<String, dynamic> toJson() =>
      _$Fragment$RecipePreviewFragment$RecipeTags$TagToJson(this);
  int get hashCode {
    final l$id = id;
    final l$name = name;
    final l$$__typename = $__typename;
